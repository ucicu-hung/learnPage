...
!function (a, b) {
  ...
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = b(require("jquery")) : "function" == typeof define && define.amd ? define("gridster-coords", ["jquery"], b) : a.GridsterCoords = b(a.$ || a.jQuery);
}(void 0, function (a) {
  "use strict";
  ...
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = b(require("jquery")) : "function" == typeof define && define.amd ? define("gridster-collision", ["jquery", "gridster-coords"], b) : a.GridsterCollision = b(a.$ || a.jQuery, a.GridsterCoords);
}(void 0, function (a, b) {
  "use strict";
  ...
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = b(require("jquery")) : "function" == typeof define && define.amd ? define("gridster-draggable", ["jquery"], b) : a.GridsterDraggable = b(a.$ || a.jQuery);
}(void 0, function (a) {
  "use strict";
  ...
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = b(require("jquery"), require("./jquery.draggable.js"), require("./jquery.collision.js"), require("./jquery.coords.js"), require("./utils.js")) : "function" == typeof define && define.amd ? define(["jquery", "gridster-draggable", "gridster-collision"], b) : a.Gridster = b(a.$ || a.jQuery, a.GridsterDraggable, a.GridsterCollision);
  ...
  var f = a(window),
    ...
    shift_widgets_up: !0,
    show_element: function show_element(a, b) {
      b ? a.fadeIn(b) : a.fadeIn();
    },
    hide_element: function hide_element(a, b) {
      b ? a.fadeOut(b) : a.fadeOut();
    },
    serialize_params: function serialize_params(a, b) {
      return {
        col: b.col,
        row: b.row,
        size_x: b.size_x,
  ...
  return h.init = function () {
    ...
    return 0 > e ? (this.get_min_col() > -1 * e ? this.shift_cols(e) : this.resize_widget_dimensions(this.options), setTimeout(a.proxy(function () {
    ...
    return a.each(this.$widgets, a.proxy(function (b, c) {
      ...
      "object" == _typeof(d) && this.update_widget_dimensions(a(c), d);
    }, this)), this;
    ...
    this.set_cells_player_occupies(f, g), this.$player.coords().grid.row = g, this.$player.coords().grid.col = f, this.$player.addClass("player-revert").removeClass("player").attr({
      "data-col": f,
      "data-row": g
    }).css({
      left: "",
          ...
          if (n.is_swap_occupied(g, e.row, e.size_x, e.size_y) || n.is_player_in(g, e.row) || n.is_in_queue(g, e.row, d)) {
            if (n.is_swap_occupied(e.col, m.rows[0], e.size_x, e.size_y) || n.is_player_in(e.col, m.rows[0]) || n.is_in_queue(e.col, m.rows[0], d)) {
              if (n.is_swap_occupied(e.col, o, e.size_x, e.size_y) || n.is_player_in(e.col, o) || n.is_in_queue(e.col, o, d)) {
                if (n.is_swap_occupied(m.cols[0], m.rows[0], e.size_x, e.size_y) || n.is_player_in(m.cols[0], m.rows[0]) || n.is_in_queue(m.cols[0], m.rows[0], d)) for (var p = 0; l > p; p++) {
                  for (var q = 0; k > q; q++) {
                    var r = m.cols[0] + p,
                        s = m.rows[0] + q;
    ...
    for (var e = !1, f = 0; c > f; f++) {
      for (var g = 0; d > g; g++) {
        var h = a + f,
            i = b + g,
            j = h + "_" + i;
        if (this.is_occupied(h, i)) e = !0;else if (j in this.w_queue) {
    ...
    var d = !1,
        e = a + "_" + b;
    if (e in this.w_queue) if ("full" === this.w_queue[e]) d = !0;else {
    ...
    return this.for_each_column_occupied(a, function (f) {
      ...
      for (var h = b + 1; --h > 0 && (!this.is_widget(f, h) || this.is_player_in(f, h) || g[h].is(a.el));) {
        this.is_player(f, h) || this.is_placeholder_in(f, h) || this.is_player_in(f, h) || d[f].push(h), e > h && (e = h);
      }
    ...
    if (this.options.shift_larger_widgets_down) for (var d = 0, e = c.length; e > d; d++) {
    ...
    if (this.for_each_column_occupied(b, function (a) {
      for (g[a] = [], e = h; e-- && this.is_empty(a, e) && !this.is_placeholder_in(a, e);) {
        g[a].push(e);
      }
    ...
    for (f = d; f >= b; f--) {
      for (g = e; g >= c; g--) {
        h = this.is_widget(f, g), h !== !1 && (i = h.data("coords").grid, i.col >= b && i.col <= d && i.row >= c && i.row <= e && (j = j.add(h)));
      }
    }
